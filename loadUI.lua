...
--function() CommF_:InvokeServer("SetTeam", "Marines")
    ...
    -- START
    local FruitOptionsTab = Window:CreateTab('Fruits Options', true, 'rbxassetid://3926305904', Vector2.new(524, 44), Vector2.new(36, 36))
    
    local FruitOptionsSelect = FruitOptionsTab:CreateSection('Fruit Options')
    
    local fruit1 = FruitOptionsSelect:CreateToggle('Kitsune', false, Color3.fromRGB(0, 125, 255), 0.25, function(Value)
        if Value then
    ...
    local autoStorageFrui = FruitOptionsSelect:CreateButton('Auto Storage Fruit', function()
        Library:CreateNotification('Storage fruit...', 'Loading...', 2)
        local hop = loadstring(game:HttpGet('https://raw.githubusercontent.com/ZhxCKaMPVfef/huhu/master/storefruit.lua'))()
    end)
    ...
    local LibraryFunctions = Window:CreateTab('UI Configuration', false, 'rbxassetid://3926305904', Vector2.new(524, 44), Vector2.new(36, 36)) --Library Functions
